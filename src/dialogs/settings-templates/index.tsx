...
export function openTemplatesSettings(){

  return OpenDialog({
    header : <div><h1>Templates</h1></div>,
    ...
    footer : <div style = {{display : 'inline-flex' , justifyContent : "flex-end" , gap : "10px" , padding : "10px"}}>
      <ThoriumButton>Delete</ThoriumButton>
      <ThoriumButton appearance="accent" >Create new template</ThoriumButton>
    </div>
  })
