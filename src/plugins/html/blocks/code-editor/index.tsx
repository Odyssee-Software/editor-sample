...
export const TypescriptEditor = ( props : { env } ):EditorContainerElement => {
  ...
  return <div 
    name = 'typescript-code-editor' 
    // display = "false" 
    className = { style.TypescriptEditor } >
    <div
      name = "editor"
...
export class CodeEditor {
  ...
  get watcherId(){ 
    return this.watcherIdState as any;
  }
  ...
  render(){
    ...
    return DOM.render<CodeEditorElement>( <div 
      ...
      _className = { style.CodeEditorContainer }
      ...
      >
        <div className = { style.CodeEditorMenu } >
          ...
          <Controls buttons = {[
            <ThoriumButton textContent='settings ⛔️' />,
            <ThoriumButton textContent='open Editor' _onmousedown={() => { 
            ...
            <ThoriumButton textContent='code' _onmousedown = {action_ButtonCode} />,
            <ThoriumButton textContent='style' _onmousedown = {action_ButtonStyle} />,
            <ThoriumButton textContent='view' _onmousedown = {action_ButtonView} />
          ]}/>
        </div>
        <div className = { style.CodeEditorCodeWorkspace }>
